...
<body class="w3-light-grey w3-content" style="max-width: 1600px">
	...
	<nav class="w3-sidebar w3-collapse w3-white w3-animate-left"
		...
		<div class="w3-bar-block">
			<a href="#portfolio" onclick="w3_close()"
				...
				class="fa fa-th-large fa-fw w3-margin-right"></i>Etude</a> <a
				href="#about" onclick="w3_close()"
				class="w3-bar-item w3-button w3-padding"><i
				class="fa fa-user fa-fw w3-margin-right"></i>Service</a> <a
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<header id="portfolio">
			...
			<%@include file="include/variableURL.jsp"%>
			...
			<div class="w3-container">
				...
				<div class="w3-section w3-bottombar w3-padding-16">
					...
					<button class="w3-button w3-black">
						<a href=<c:out value="${lienClient}"/>>Créer un patient</a>
					</button>
					<button class="w3-button w3-white w3-hide-small">
						<a href=<c:out value="${lienCommande }"/>>Creer une commande</a>
					</button>
				</div>
			</div>
		</header>