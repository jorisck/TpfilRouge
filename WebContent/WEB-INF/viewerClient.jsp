    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-third w3-margin-bottom">
        <ul class="w3-ul w3-border w3-white w3-center w3-opacity w3-hover-opacity-off">
          ...
          <li class="w3-light-grey w3-padding-24">
            <button class="w3-button w3-teal w3-padding-large w3-hover-black">Insertion de commande(s)</button>
          </li>
        </ul>
      </div>
      ...
      <div class="w3-third w3-margin-bottom">
        <ul class="w3-ul w3-border w3-white w3-center w3-opacity w3-hover-opacity-off">
          ...
          <li class="w3-padding-16">${client1.firstname}</li>
          <li class="w3-padding-16">${client1.lastname}</li>
          <li class="w3-padding-16">${client1.adress}</li>
          <li class="w3-padding-16">${client1.phoneNumber}</li>
          <li class="w3-padding-16">${client1.email}</li>
          <li class="w3-light-grey w3-padding-24">
